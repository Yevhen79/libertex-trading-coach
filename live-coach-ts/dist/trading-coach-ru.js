...
(() => {
  ...
  var ru = {
    ...
    stopSet: "Стоп-лосс <b>стоял</b> ✓ — риск был ограничен заранее.",
    noStopOnLoss: "Стоп-лосс <b>не стоял</b> ✕ — при таком плече убыток не был ничем ограничен.",
    noStop: "Стоп-лосс <b>не стоял</b> ✕ — риск в сделке не был ограничен заранее.",
    ...
    revengeLev: (cur, prev2) => `бо́льшим плечом (×${cur} против ×${prev2})`,
    revengeMargin: (curK, prevK) => `бо́льшей маржой ($${curK} против $${prevK})`,
    revengeAnd: " и ",
    revengeBody: (min, risk) => `Прошлая сделка закрылась в минус ${min} мин назад. Эта открыта с ${risk}. По времени и риску — это отыгрыш.`,
